<template>
    <Navbar class="" />
    <div class="lg:px-40 mb-40 lg:w-9/10 lg:mx-auto">
        <div class="bg-white h-4/5 lg:h-6/7 w-11/12 lg:w-8/9 mb-10 p-2 mt-4 ml-7 rounded-2xl ">
            ...
            <div
                class="bg-gradient-to-l from-[#1B7590] to-[#1B7B90]  relative h-[350px] w lg:w-8/9 mx-auto mb-4 rounded-2xl p-8">
                <div class="ml-28">
                    <div
                ...
                <div class="md:w-">
                    <div class="w-screen md:w-4/5 md:px-4 md:mx-auto px-4 -ml-10 mb-3">
                        <label for="" class="text-gray-100 ">Current Password</label>
                        <input type="text" class="w-11/12 h-10 mt-2 outline-none rounded-lg bg-white">
                    </div>
                    <div class="w-screen px-4 -ml-10 mb-3 md:w-4/5 md:px-4 md:mx-auto">
                        <label for="" class="text-gray-100 ">New Password</label>
                        <input type="text" class="w-11/12 h-10 mt-2 outline-none rounded-lg bg-white">
                    </div>
                    <div class="w-screen px-4 -ml-10 mb-3 md:w-4/5 md:px-4 md:mx-auto">
                ...
                <div class="flex mx-auto md:h-10 mt-6 lg:mt-2 w-11/12   lg:w-64 md:w-64 md:-mt-1 md:mx-auto">
                    <div class="flex bg-[#075E86] w-11/12 h-10 py- px-2 rounded-lg ">
                        <button class=" text-[14px] text-center px-13 font-normal text-white">Reset Password</button>
                    </div>
