        ...
        >
          <div class="md:w-">
            <div class="w-screen md:w-4/5 md:px-4 md:mx-auto px-4 -ml-10 mb-3">
              <label for="currentPassword" class="text-gray-100"
              ...
              <div class="flex">
                ...
                />
                <i
                  @click="toggleCurrentPassowrd"
                  :class="
                    showCurrentPassword
                      ? 'fa-regular fa-eye-slash'
                      : 'fa-regular fa-eye'
                  "
                  class="-ml-8 mt-5 cursor-pointer"
                ></i>
              </div>
            </div>
            <div class="w-screen px-4 -ml-10 mb-3 md:w-4/5 md:px-4 md:mx-auto">
              <label for="newPassword" class="text-gray-100"
                >New Password</label
              >
              <div class="flex">
                <input
            ...
            <div class="w-screen px-4 -ml-10 mb-3 md:w-4/5 md:px-4 md:mx-auto">
              <label for="confirmPassword" class="text-gray-100"
