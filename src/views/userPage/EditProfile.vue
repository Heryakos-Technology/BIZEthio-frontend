    ...
    <div class="lg:px-20 mb-40 lg:w-9/10 lg:mx-auto lg:pt- lg:pb-80">
      ...
      >
        ...
        >
          ...
          <div v-else class="flex lg:-ml-20">
            <div class="relative flex justify-center">
              ...
              <i
                ...
                class="fa-solid fa-camera-retro cursor-pointer text-gray-200 absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-1/2 md:text-lg lg:text-2xl"
              ></i>
            </div>
            <input
              type="file"
              ...
              <div class="flex ml-4 w-56 mt-6 md:ml-20">
                ...
                >
                  ...
                  <input
                    ...
                    class="border-b-2 w-56 mt-1 outline-none h-9"
          ...
          <div
            class="flex -ml-14 absolute md:h-10 mt-10 lg:ml-8 lg:mt-14 w-80 lg:w-full md:w-full md:-mt-1 md:mx-auto"
          >
            <div
              @click="backToProfile"
            ...
            <router-link
              to="/ChangePassword"
              class="flex bg-[#075E86] hover:bg-[#6291a7] w-36 py-2 px-2 rounded-lg"
            >
              <p
          ...
          <div class="text-white lg:ml-28 lg:-mt-4 -ml-2 w-11/12">
            <div class="flex ml-4 w-56 mt-6 md:ml-20 lg:ml-56">
              ...
              ></div>
              <div
                class="text-[12px] w-5/6 font-normal cursor-pointer text-gray-100 -mt-4 ml-5 md:text-[16px]"
              >
                <button
...
export default {
  ...
  setup() {
    ...
    const fetchUserInfo = async () => {
      ...
      try {
        ...
        const response = await axios.get(
          `https://bizethio-backend-production-daf6.up.railway.app/api/users/${userId}`,
          {
            headers: {
        ...
        localStorage.setItem(
          "userInformations",
          JSON.stringify(userInformations.value)
        );
    ...
    const handleLocationSelected = (latlng) => {
      ...
      if (
        userInformations.value.location.lat !== null &&
        userInformations.value.location.lng !== null
      ) {
        showMap.value = false;
    ...
    onMounted(() => {
      ...
      localStorage.getItem("userInformations") &&
        (userInformations.value = JSON.parse(
          localStorage.getItem("userInformations")
        ));
    });
