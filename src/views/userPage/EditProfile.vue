      ...
      >
        ...
        >
          ...
          <div class="flex lg:-ml-20">
            ...
            />
            <i
              class="fa-solid fa-camera-retro text-gray-200 mt-6 -ml-3 md:text-lg md:-ml-2 md:mt-10 lg:text-2xl lg:mt-32 lg:-ml-8"
            ></i>
          ...
          <div
            class="flex -ml-14 md:h-10 mt-10 lg:mt-2 w-80 lg:w-full md:w-full md:-mt-1 md:mx-auto"
          >
            <div
              class="flex ml-16 bg-[#075E86] rounded-lg px-4 w-16 h-10 md:10 md:ml-72 lg:-ml-10 lg:w-20 lg:mx-auto"
            >
              <button
                @click="backToProfile"
            ...
            >
              <button
                @click="saveUserInfo"
                class="text-[14px] font-normal text-white lg:text-center ml-2"
              >
                Save
              </button>
            </div>
