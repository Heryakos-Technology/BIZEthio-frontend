        ...
        <div class=" pb-10">
          ...
          >
            <div class="absolute inset-0 bg-gray-100">
              <h1 class="text-center mt-8 font-bold text-xl w-1/2">SIgn In as a Campany</h1>
  ...
  sign in
              ...
              <div class="mt-5 w-12/10 mx-auto md:w-2/3 md:mx-auto">
                <p class="md:text-lg text-sm w-12/10 mx-auto -ml-4 lg:text-sm ">
                  Don't You Register as a Campany ?  </p> <br>
                  <span
      ...
      const handleLogin = async () => {
        ...
        try {
          ...
          if (user) {
            ...
            loading2.value = true;
            const response = await axios.post(
              `https://bizethio-backend-production-944c.up.railway.app/api/company/login`,
              {
                contact_email: email.value,
                password: password.value,
                token: token,
