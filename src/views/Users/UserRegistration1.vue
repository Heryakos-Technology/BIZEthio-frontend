      ...
      <div class="bg-white rounded-sm pb-10 lg:hidden ">
        ...
        <div class="w-2/3 mx-auto mt-10">
          <div>
            ...
            <input type="text" class="border-2 rounded-md focus:outline-none border-blue-300 w-13/13 md:h-12" v-model="model.user.name" @input="validate">
          ...
          <div class="mt-9">
            ...
            <input type="email" class="border-2 rounded-md focus:outline-none border-blue-300 w-13/13 md:h-12" v-model="model.user.email" @input="validate">
          ...
          <div class="mt-9">
            ...
            <input type="tel" class="border-2 rounded-md focus:outline-none border-blue-300 w-13/13 md:h-12" v-model="model.user.phone_number" @input="validate">
            <div v-if="errors.phone_number" class="text-red-400 mt-1">{{ errors.phone_number }}</div>
          </div>
          ...
          <div class="mt-9">
            ...
            <input type="text" class="border-2 rounded-md focus:outline-none border-blue-300 w-13/13 md:h-12" v-model="model.user.city" @input="validate">
            <div v-if="errors.city" class="text-red-400 mt-1">{{ errors.city }}</div>
          </div>
          ...
          <div class="mt-9">
            ...
            <input type="text" class="border-2 rounded-md focus:outline-none border-blue-300 w-13/13 md:h-12" v-model="model.user.sub_city" @input="validate">
            <div v-if="errors.sub_city" class="text-red-400 mt-1">{{ errors.sub_city }}</div>
          </div>
          ...
          <div class="mt-9">
            ...
            <input type="text" class="border-2 rounded-md focus:outline-none border-blue-300 w-13/13 md:h-12" v-model="model.user.location" @input="validate">
            <div v-if="errors.location" class="text-red-400 mt-1">{{ errors.location }}</div>
          </div>
      ...
      <div class="hidden lg:block w-2/3 mx-auto pb-10 mt-3">
        <div class="flex justify-between">
          <div class="bg-[#BDE5F2] rounded-l-md px-10 pt-20 w-1/2 pb-20">
            ...
            testimonials, and contact information to foster
          ...
          <div class="bg-white rounded-r-md w-2/3 mx-auto px-10 pb-20">
            ...
            <div>
              <div class="mt-4">
                ...
                <div class="mt-2 ">
                  <input type="text" class="focus:outline-none pl-3 border-2 rounded-xl border-blue-300 w-13/13 md:h-12" v-model="model.user.name" @input="validate">
                </div>
                <div v-if="errors.name" class="text-red-400 mt-1">{{ errors.name }}</div>
              </div>
              <div class="mt-9">
                ...
                <div class="mt-2 ">
                  <input type="text" class="focus:outline-none pl-3 border-2 rounded-xl border-blue-300 w-13/13 md:h-12" v-model="model.user.email" @input="validate">
                </div>
                <div v-if="errors.email" class="text-red-400 mt-1">{{ errors.email }}</div>
              </div>
              <div class="mt-9">
                ...
                <div class="mt-2 ">
                  <input type="text" class="focus:outline-none pl-3 border-2 rounded-xl border-blue-300 w-13/13 md:h-12" v-model="model.user.phone_number" @input="validate">
                  <div v-if="errors.phone_number" class="text-red-400 mt-1">{{ errors.phone_number }}</div>
                </div>
              ...
              <div class="mt-9">
                ...
                <div class="mt-2 ">
                  <input type="text" class="focus:outline-none pl-3 border-2 rounded-xl border-blue-300 w-13/13 md:h-12" v-model="model.user.city" @input="validate">
                  <div v-if="errors.city" class="text-red-400 mt-1">{{ errors.city }}</div>
                </div>
              ...
              <div class="mt-9">
                ...
                <div class="mt-2 ">
                  <input type="text" class="focus:outline-none pl-3 border-2 rounded-xl border-blue-300 w-13/13 md:h-12" v-model="model.user.sub_city" @input="validate">
                  <div v-if="errors.sub_city" class="text-red-400 mt-1">{{ errors.sub_city }}</div>
                </div>
              ...
              <div class="mt-9">
                ...
                <div class="mt-2 ">
                  <input type="text" class="focus:outline-none pl-3 border-2 rounded-xl border-blue-300 w-13/13 md:h-12" v-model="model.user.location" @input="validate">
                  <div v-if="errors.location" class="text-red-400 mt-1">{{ errors.location }}</div>
                </div>
  ...
  Object.keys(model.value.user).forEach(key => {
    model.value.user[key] = localStorage.getItem(key) || '';
      ...
      const validate = () => {
        ...
        if (!model.value.user.phone_number) errors.value.phone_number = 'Phone number is required.';
        if (!model.value.user.city) errors.value.city = 'City is required.';
        if (!model.value.user.sub_city) errors.value.sub_city = 'Subcity is required.';
        if (!model.value.user.location) errors.value.location = 'Location is required.';
      };
  
      const isButtonDisabled = computed(() => {
        return !model.value.user.name || 
