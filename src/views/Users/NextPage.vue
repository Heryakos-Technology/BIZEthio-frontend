      ...
      <div class="w-2/3 mx-auto mt-10">
        <div class="mt-9">
          ...
          <div class="mt-2">
            <input
              type="password"
              class="border-2 rounded-md border-blue-300 w-13/13 md:h-12"
        ...
        <div class="mt-9">
          ...
          <div class="mt-2 w-13/13">
            <input
              type="file"
              class="border-2 rounded-md pl-3 pt-1 border-blue-300 w-13/13 md:h-12"
            ...
            <button
              ...
              "
              class="text-black px-6 py-1 rounded-sm mt-5 w-1/2 text-sm mx-auto"
            >
              Upload File
            </button>
          </div>
          ...
          <div class="mt-5 w-12/13 mx-auto md:w-2/3 md:mx-auto">
            <p class="md:text-lg text-sm text-center">
              Do you have an account ? <span class="text-cyan-500">Login</span>
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="flex justify-between">
      <div class="bg-[#BDE5F2] rounded-md px-10 pt-20 w-1/2 pb-20">
        ...
        <p class="text-sm w-10/11 mx-auto mt-16">
          ...
          typically includes features such as an about page, product listings, a
          blog for content marketing, customer testimonials, and contact
        ...
        <div>
          <div class="mt-4">
            ...
            <div class="mt-2">
              <input
                type="password"
                class="border-2 rounded-xl border-blue-300 w-13/13 md:h-12"
                v-model="model.user.password"
              />
            </div>
          </div>
          ...
          <div class="mt-9">
            ...
            <div class="mt-2">
              <input
                type="file"
                class="border-2 rounded-xl pl-3 pt-2 border-blue-300 w-13/13 md:h-12 relative"
                @change="handleFileUpload"
                accept="image/"
              />
              <button
                ...
                "
                class="cursor-pointer text-black px-8 py-2 rounded-md h-1/17 absolute top-126 left-240"
              >
                Upload File
              </button>
            </div>
          ...
          <div class="mt-9">
            <div class="flex w-3/4 mx-auto">
              <div class="mt-2">
                <input
                  type="checkbox"
                  class="border-2 rounded-xl border-blue-300 md:h-12"
                />
              </div>
          ...
          <button
            ...
            "
            class="bg-cyan-700 text-white px-14 py-2 rounded-sm text-lg cursor-pointer"
          >
            Submit
          </button>
        </div>
...
export default {
  ...
  methods: {
    ...
    async registerUser() {
      ...
      formData.append(
        "password_confirmation",
        this.model.user.password_confirmation
      );
      formData.append(
        "verification_status",
        this.model.user.verification_status
      );
      formData.append("is_banned", this.model.user.is_banned);
      formData.append("role", this.model.user.role);
      formData.append(
        "profile_picture_url",
        this.model.user.profile_picture_url
      );
