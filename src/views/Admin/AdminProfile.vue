...
<template>
  <AdminLayout>
    <div class="bg-white grid relative max-w-[350px] pt-16 mt-32 mx-auto">
      <div
        class="rounded-full size-48 bg-cover bg-center absolute top-[-150px] left-[25%]"
        :style="{ backgroundImage: `url(${admin_user_profile})` }"
      ></div>

      <div class="">
        <div class="px-10">
          <h1 class="font-bold text-center text-xl">Temesgen Beyene</h1>
          <div class="flex justify-between">
            <div class="flex gap-x-2 font-semibold items-center text-lg">
              <img :src="admin_profile_setting" :alt="admin_profile_setting" />
              Admin
            </div>
      ...
      <button class="bg-[#241ee5] mx-auto my-6 text-white rounded-md px-8 py-2">
        Edit Profile
      </button>
    </div>
  </AdminLayout>
