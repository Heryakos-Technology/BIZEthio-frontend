...
export const useCategoryStore = defineStore("categoryStore", {
  ...
  actions: {
    async getAllCategories() {
      ...
      const res = await fetch("https://bizethio-backend-production-daf6.up.railway.app/api/categories", {
        method: "GET",
        headers: {
    ...
    async getMostPopularCategories() {
      ...
      const res = await fetch("https://bizethio-backend-production-daf6.up.railway.app/api/categories/popular", {
        method: "GET",
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
        },
    ...
    async getLeastPopularCategories() {
      ...
      const res = await fetch("https://bizethio-backend-production-daf6.up.railway.app/api/categories/least-popular", {
        method: "GET",
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
        },
    ...
    async deleteCategory(categoryId) {
      localStorage.removeItem("all_categories");
      const res = await fetch(`https://bizethio-backend-production-daf6.up.railway.app/api/categories/${categoryId}`, {
        method: "DELETE",
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
        },
