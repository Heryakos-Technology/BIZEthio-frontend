  ...
  >
    ...
    >
      ...
      >
        ...
        <div class="flex gap-x-8 w-40 xl:w-full">
          <i class="fa-brands fa-facebook text-white ml-2 mt-2"></i>
          <i class="fa-brands fa-telegram text-white ml-2 mt-2"></i>
          <i class="fa-brands fa-instagram text-white ml-2 mt-2"></i>
        </div>
      </div>
    </div>
